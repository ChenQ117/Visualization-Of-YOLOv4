...
if __name__ == "__main__":
    ...
    imshow = cv2.imread("/data0/BigPlatform/YOLOv4-pytorch/YOLOv4-cq/data/imgs/000001.jpg")
    ...
    visualize_boxes(
        ...
        labels=_labels,
        probs=_probs,
        class_labels=cateNames,
    )
    cv2.imwrite("/data0/BigPlatform/YOLOv4-pytorch/YOLOv4-cq/res.jpg", imshow)
